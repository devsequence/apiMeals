...
<!--          <img class="w-24" :src="urlImage+ingredient.strIngredient+`-Small.png`" alt="">-->
<!--        </a>-->
        <a href="#" class="block bg-white rounded p-3 mb-3 shadow" @click.prevent="openIngredientItem(item)" v-for="item in paginatedData" :key="item.idIngredient">
